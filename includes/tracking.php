...
$gtmContainerId = getSetting('gtm_container_id');
...
})(window,document,'script','dataLayer','<?php echo htmlspecialchars($gtmContainerId, ENT_QUOTES, 'UTF-8'); ?>');</script>
...
<?php
/**
 * Output GTM noscript for <body> tag
 * Call this immediately after opening <body> tag
 */
function outputGTMBodyNoscript() {
    $gtmContainerId = getSetting('gtm_container_id');
